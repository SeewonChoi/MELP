...
def main(hparams: Namespace):
    ...
    elif hparams.model_name in ["leadfusion", "vqnsp", "heartlang", "ecgfm", "kardianet"]:
        callbacks = [
            LearningRateMonitor(logging_interval="step"),
    ...
    elif hparams.model_name == "kardianet":
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_name", type=str, default="kardianet",
                        choices=["merl", "ecgfm", "melp", 'kardianet'])
